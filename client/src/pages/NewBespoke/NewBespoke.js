...
function bespokeAppearCheck() { //비스포크 지원 제품인지 확인 및 옵션 가리기
...
setTimeout(() => {
  ...
  // = new JnsBespoke(getOwnProductCode, document.querySelector('.bespoke-container'), document.querySelector('.preview-container'));
